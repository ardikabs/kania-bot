                                    ...
                                    mapsClient.placesPhoto(photoQuery, (err,res)=>{
                                        ...
                                        carouselMsg.addColumn(
                                            ...
                                            [
                                                ...
                                                ActionBuilder.createUriAction("Liat Map","https://maps.google.com/maps?&z=20&q="+result[i].geometry.location.lat+"+"+result[i].geometry.location.lng+"&query_place_id="+result[i].place_id),
